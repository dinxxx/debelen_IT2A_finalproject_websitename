      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 menu-wrap">
            ...
            <div class="menus d-flex ftco-animate">
              <div class="menu-img img" style="background-image: url(images/sm.jpg);"></div>
              <div class="text">
                <div class="d-flex">
                  <div class="one-half">
                    <h3><h3>Mixberry Yogurt Smoothie</h3>
                  </div>
                  <div class="one-forth">
                    <span class="price">P260</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="menus d-flex ftco-animate">
              <div class="menu-img img" style="background-image: url(images/fr.jpg);"></div>
              <div class="text">
                <div class="d-flex">
                  <div class="one-half">
                    <h3> Coffee Frappe</h3>
          ...
          <div class="col-md-6 col-lg-4 menu-wrap">
            ...
            <div class="menus d-flex ftco-animate">
              <div class="menu-img img" style="background-image: url(images/tea.jpg);"></div>
              <div class="text">
                <div class="d-flex">
                  <div class="one-half">
            ...
            <div class="menus d-flex ftco-animate">
              <div class="menu-img img" style="background-image: url(images/milk.jpg);"></div>
              <div class="text">
                <div class="d-flex">
                  <div class="one-half">
                    <h3>Milk</h3>
             ...
             <div class="menus d-flex ftco-animate">
              <div class="menu-img img" style="background-image: url(images/soda.jpg);"></div>
              <div class="text">
                <div class="d-flex">
                  <div class="one-half">
                    <h3>Soda</h3>
